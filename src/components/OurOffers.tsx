    ...
    <div ref={ref} className=" h-auto w-[95%] mx-auto mt-2 md:mt-8">
        ...
        <div className=" h-[200px] mt-4 md:h-[290px] md:w-[800px] flex items-center">
           ...
           <h3 className=" text-lg uppercase text-gray-500 font-normal">Our Services</h3>
            ...
            <p className="text-gray-500">I provide personalized cardiovascular care. From routine check-ups to advanced heart treatments, we're here for you. Contact us today!</p>
           </div>
        </div>
        <div className=" h-[290px] relative bg-gray-200 rounded-lg w-[80vw] mx-auto md:w-[25vw] flex items-center">
           ...
           <p className="text-gray-500">This helps in identifying blockages or abnormalities in the coronary arteries.</p>
           </div>
           </div>
        </div>
        <div className=" h-[290px] rounded-lg bg-slate-600 relative w-[80vw] mx-auto md:w-[25vw] text-white flex items-center">
           <div className=" w-[90%] h-full mx-auto flex flex-col justify-between py-8 gap-2">
           <p className=" text-2xl text-gray-400">/<span className=" text-3xl">2</span></p>

           <div>
           <h1 className=" text-3xl font-medium">Angioplasty</h1>
           <p className="">It restores normal blood flow to the heart, improving overall cardiovascular function.</p>
           </div>
           </div>
        </div>
        </div>
        <div className="flex gap-4 mt-4 flex-col md:flex-row">
        <div className=" h-[320px] rounded-lg relative bg-gray-200 w-[80vw] mx-auto md:w-[25vw] flex items-center">
           <div className=" w-[90%]  h-full mx-auto flex flex-col justify-between py-8 gap-2">
        ...
        <div className=" h-[320px] rounded-lg bg-slate-600 relative w-[80vw] mx-auto md:w-[25vw] text-white flex items-center">
           <div className=" w-[90%] h-full mx-auto flex flex-col justify-between py-8 gap-2">
           ...
           <div>
            ...
            <p className="">These appointments include routine evaluations and advice on maintaining optimal cardiovascular well-being.</p>
           </div>
           </div>
        </div>
        <div
        ...
        className=" h-[320px] cursor-pointer relative rounded-lg w-[80vw] mx-auto md:w-[800px] flex items-center">
       ...
       <div className=" h-[350px] rounded-lg bg-slate-600 relative w-[80vw] mx-auto md:w-[25vw] text-white flex items-center">
           <div className=" w-[90%] h-full mx-auto flex flex-col justify-between py-8 gap-2">
        ...
        <div className=" h-[350px] rounded-lg relative bg-gray-200 w-[290px] flex items-center">
           ...
           <p className=" text-2xl text-gray-400">/<span className=" text-3xl">6</span></p>
            ...
            <p className="text-gray-500">This enables accurate diagnosis and management of irregular heartbeats.</p>
            </div>
           </div>
        </div>
       </div>
