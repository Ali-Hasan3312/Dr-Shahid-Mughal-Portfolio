...
const Footer = (
    ...
    return (
      <div className="bg-gray-200 relative w-[90%] mx-auto mt-8 py-8 rounded-t-lg">
       <div className="max-w-[80%] mx-auto flex justify-between items-start mb-8">
